...
<body class="d-flex justify-content-center align-items-center survey">
    <form id="questions" class="container-fluid max-mobile mx-auto text-white m-5 p-5">
        ...
        <div class="progress">
            <div class="progress-bar" style="background-color: ;" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
